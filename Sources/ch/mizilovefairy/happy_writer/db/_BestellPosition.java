...
public abstract class _BestellPosition extends  ERXGenericRecord {
  ...
  // Relationship Keys
  public static final ERXKey<ch.mizilovefairy.happy_writer.db.Artikel> ARTIKEL = new ERXKey<ch.mizilovefairy.happy_writer.db.Artikel>("artikel", Type.ToOneRelationship);
  public static final ERXKey<ch.mizilovefairy.happy_writer.db.Bestellung> BESTELLUNG = new ERXKey<ch.mizilovefairy.happy_writer.db.Bestellung>("bestellung", Type.ToOneRelationship);
  public static final ERXKey<ch.mizilovefairy.happy_writer.db.Inhalt> INHALTE = new ERXKey<ch.mizilovefairy.happy_writer.db.Inhalt>("inhalte", Type.ToManyRelationship);
  ...
  public NSArray<ch.mizilovefairy.happy_writer.db.Inhalt> inhalte(EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings) {
    NSArray<ch.mizilovefairy.happy_writer.db.Inhalt> results;
      results = inhalte();
      if (qualifier != null) {
        results = (NSArray<ch.mizilovefairy.happy_writer.db.Inhalt>)EOQualifier.filteredArrayWithQualifier(results, qualifier);
      }
      if (sortOrderings != null) {
        results = (NSArray<ch.mizilovefairy.happy_writer.db.Inhalt>)EOSortOrdering.sortedArrayUsingKeyOrderArray(results, sortOrderings);
      }
    return results;
  }
  ...
  public ch.mizilovefairy.happy_writer.db.Inhalt createInhalteRelationship() {
    EOEnterpriseObject eo = EOUtilities.createAndInsertInstance(editingContext(),  ch.mizilovefairy.happy_writer.db.Inhalt.ENTITY_NAME );
