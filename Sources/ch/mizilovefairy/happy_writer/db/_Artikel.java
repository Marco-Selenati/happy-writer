...
public abstract class _Artikel extends  ERXGenericRecord {
  ...
  public NSArray<ch.mizilovefairy.happy_writer.db.BestellPosition> bestellPositionen() {
    return (NSArray<ch.mizilovefairy.happy_writer.db.BestellPosition>)storedValueForKey(_Artikel.BESTELL_POSITIONEN_KEY);
  }
  ...
  public NSArray<ch.mizilovefairy.happy_writer.db.BestellPosition> bestellPositionen(EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings, boolean fetch) {
    ...
    if (fetch) {
      ...
      EOQualifier inverseQualifier = ERXQ.equals(ch.mizilovefairy.happy_writer.db.BestellPosition.ARTIKEL_KEY, this);
