...
public abstract class _Bestellung extends ERXGenericRecord {
	...
	public static final ERXKey<ch.mizilovefairy.happy_writer.db.Kunde> KUNDEN = new ERXKey<ch.mizilovefairy.happy_writer.db.Kunde>(
			"kunden", Type.ToOneRelationship);
	...
	public NSArray<ch.mizilovefairy.happy_writer.db.BestellPosition> bestellPositionen() {
		return (NSArray<ch.mizilovefairy.happy_writer.db.BestellPosition>) storedValueForKey(
				_Bestellung.BESTELL_POSITIONEN_KEY);
	}
	...
	public NSArray<ch.mizilovefairy.happy_writer.db.BestellPosition> bestellPositionen(EOQualifier qualifier,
		...
		if (fetch) {
			...
			EOQualifier inverseQualifier = ERXQ.equals(ch.mizilovefairy.happy_writer.db.BestellPosition.BESTELLUNG_KEY,
					this);
